...
# Script to link existing AI posts to topics
# This will create ai_generated_threads records for existing AI posts

echo "🔗 Linking AI posts to topics..."
...
-- Get AI posts that need linking
...
INSERT INTO ai_generated_threads (thread_id, topic_id, ai_admin_id, ai_model, created_at, updated_at)
SELECT 
    t.thread_id,
    CASE 
