...
# Complete cleanup script for extra AI users
...
echo "🧹 Starting complete cleanup of extra AI users..."
...
if docker-compose -f docker-compose.local.yml ps | grep -q "urutte-postgres-local"; then
    ...
    -- 9. Delete AI generated thread records
    ...
    -- 10. Delete follow relationships
    ...
    -- 14. Delete the users themselves
...
echo "✅ Complete cleanup script completed!"
echo ""
