...
# Script to fix AI admin and link AI posts to topics
# This will create the correct AI admin entry and link posts

echo "🔧 Fixing AI admin and linking AI posts to topics..."
...
echo "📊 Fixing AI admin and linking AI posts..."
...
-- Create AI admin for ai.assistant@urutte.com if it doesn't exist
\echo 'Creating AI admin for ai.assistant@urutte.com...'
INSERT INTO ai_admins (email, name, created_at, updated_at)
SELECT 'ai.assistant@urutte.com', 'AI Assistant', NOW(), NOW()
WHERE NOT EXISTS (
...
\echo '✅ AI admin fixed and AI posts linked to topics successfully!'

SQL_EOF

echo "✅ AI admin fixed and AI posts linked!"

EOF

echo "✅ AI admin and posts linking completed!"
echo ""
