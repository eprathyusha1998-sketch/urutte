...
echo -e "${GREEN}🤖 Setting up AI Content Generation System${NC}"
echo ""
...
echo -e "   ✅ Start scheduled jobs (every 2 hours)"
...
if [ "$topics_count" -gt 0 ]; then
    ...
    echo -e "${YELLOW}⚠️  No topics found or jq not installed${NC}"
fi
...
# Show configuration
echo ""
echo -e "${GREEN}🎉 AI Content Generation System Setup Complete!${NC}"
echo ""
...
echo -e "   • Generation Schedule: Every 2 hours"
echo -e "   • High Priority: Every 1 hour"
...
echo -e "   • Max threads per topic: 3-5 (configurable per topic)"
echo ""
...
echo -e "   ⏰ First content generation will happen within 2 hours"
...
echo ""
echo -e "${GREEN}🚀 Your AI content generation system is ready!${NC}"
